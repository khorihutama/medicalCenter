           ...
           <?php foreach ($modelsObat as $i => $modelsObat): ?>
               <div class="item panel panel-default"><!-- widgetBody -->
                   ...
                   <div class="panel-body">
                       ...
                       <div class="row">
                            <div class="col-sm-12">
                         <?= $form->field($modelsObat, 'id_obat')->widget(Select2::classname(), [
                             'data' => $data,
                             'options' => ['placeholder' => 'Pilih obat ...'],
                             'pluginOptions' => [
                             'allowClear' => true
                           ...
                           <div class="col-sm-6">
                               <?= $form->field($modelsObat, "[{$i}]dosis")->textInput(['maxlength' => true]) ?>
                           </div>
                           <div class="col-sm-6">
                               <?= $form->field($modelsObat, "[{$i}]status")->textInput(['maxlength' => true]) ?>
                           </div>
                       </div><!-- .row -->
                   </div>
               </div>
